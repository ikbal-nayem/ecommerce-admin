...
const AppInfoAndSupport = ({ appInfo }) => (
  <>
    <div className="card wx__details_mid_right wx__mt-3 wx__p-4">
      <h5>Info</h5>
      {appInfo ? (
        <ul>
    ...
    <div className="card wx__details_mid_right wx__p-4 wx__mt-3">
      <h5>Support</h5>
      {appInfo ? (
        <>
          <div className="d-flex wx__align-items-center wx__mb-3">
            <WxIcon
              icon="apartment"
              variants="filled"
