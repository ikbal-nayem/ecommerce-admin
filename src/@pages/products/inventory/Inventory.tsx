import { BlockSectionWithMessage } from '@components/BlockSection/BlockSectionWithMessage';
...
const Inventory = () => {
	...
	useEffect(() => {
		isInit.current && AdminService.getVariantAdjustReason().then((res) => setReasonList(res.body));
	...
	return (
		<MainFull>
			...
			{isLoader ? (
				...
				<BlockSectionWithMessage isBlocked message='This feature is under development!'>
					<div className='card mt-3'>
						...
						{inventoryData?.length ? (
							<>
								...
								<div className='p-3'>
									<Pagination meta={productMeta} />
								</div>
							</>
						) : null}

						{!isLoading && !inventoryData.length ? <WxNotFound title='No inventory item found!' /> : null}
					</div>
				</BlockSectionWithMessage>
			)}
		</MainFull>
	);
};
