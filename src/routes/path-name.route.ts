...
export const ORDER_DETAILS: ({ order_id }) => string = ({ order_id }) => `${ORDER}/${order_id}`;
export const ORDER_EDIT: Function = ({ order_id }) => `${ORDER}/${order_id}/edit`;
export const ORDER_REFUND: Function = ({ order_id }) => `${ORDER}/${order_id}/refund`;
export const ORDER_RETURN: Function = ({ order_id }) => `${ORDER}/${order_id}/return`;
...
export const PRODUCT_DETAILS = ({ product_id }) => `${PRODUCT}/${product_id}`;
...
export const APP_STORE: Function = ({ appId }) => BASE_PATH + `/app-store/${appId}`;
...
export const THEMES_OVERVIEW: Function = ({ theme_id }) => `${THEMES}/${theme_id}/overview`;
export const THEMES_REVIEW: Function = ({ theme_id }) => `${THEMES}/${theme_id}/review`;
export const THEMES_SUPPORT: Function = ({ theme_id }) => `${THEMES}/${theme_id}/support`;
export const THEMES_LIST: string = THEMES + '/list';

export const THEME_CUSTOMIZATION: string = THEMES + '/customization';
export const THEME_CUSTOMIZATION_S: ({ section_key }) => string = ({ section_key }) =>
	`${THEME_CUSTOMIZATION}/s/${section_key}`;
export const THEME_CUSTOMIZATION_GENERAL: string = THEME_CUSTOMIZATION + '/general';
export const THEME_CUSTOMIZATION_HOMEPAGE: string = THEME_CUSTOMIZATION + '/homepage';
export const THEME_CUSTOMIZATION_SOCIAL: string = THEME_CUSTOMIZATION + '/social';
export const THEME_CUSTOMIZATION_TYPOGRAPHY: string = THEME_CUSTOMIZATION + '/typography';
export const THEME_CUSTOMIZATION_FOOTER: string = THEME_CUSTOMIZATION + '/footer';
export const THEME_CUSTOMIZATION_COLOR: string = THEME_CUSTOMIZATION + '/color';
export const THEME_CUSTOMIZATION_SLIDER: string = THEME_CUSTOMIZATION + '/sliders';
export const THEME_CUSTOMIZATION_SLIDER_DETAILS: Function = ({ id }) => `${THEME_CUSTOMIZATION_SLIDER}/${id}`;
...
export const SETTINGS_ROLES_EDIT: Function = ({ id }) => `${SETTINGS_ROLES}/${id}`;
...
export const SETTINGS_DELIVERY_EDIT: Function = ({ id }) => `${SETTINGS_DELIVERY}/${id}`;
export const SETTINGS_COURIER: string = SETTINGS + '/courier';
export const SETTINGS_COURIER_EDIT: Function = ({ key }) => `${SETTINGS_COURIER}/${key}`;
export const SETTINGS_PAYMENT: string = SETTINGS + '/payment';
export const SETTINGS_SITE_OPERATOR: string = SETTINGS + '/site-operator';
export const SETTINGS_SITE_OPERATOR_ADD: string = SETTINGS_SITE_OPERATOR + '/create';
export const SETTINGS_SITE_OPERATOR_EDIT: Function = ({ id }) => `${SETTINGS_SITE_OPERATOR}/${id}`;
export const SETTINGS_NOTIFICATION: string = SETTINGS + '/notification';
export const SETTINGS_NOTIFICATION_SMSGATEWAY: string = SETTINGS_NOTIFICATION + '/sms-getway';
export const SETTINGS_NOTIFICATION_ORDER: string = SETTINGS_NOTIFICATION + '/order';
...
export const PORTAL_PARTNERS_DETAILS: Function = ({ id }) => `${PORTAL_PARTNERS}/${id}`;
...
export const DOWNGRADE_PRODUCT_VARIANTS: string = DOWNGRADE + '/product-vatiants';
...
export const EXIT_DOWNGRADE_PLAN: string = '/admin' + SETTINGS + '/pricing-plan';
